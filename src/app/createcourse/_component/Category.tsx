    ...
    <div>
        ...
        <div className='mt-12 flex items-center justify-center gap-5'>
            {SelecteCategory.map((item,index)=>(
                <div key={index}>
                    <div onClick={()=>handleCategory(item.name)} className={`w-[250px]  cursor-pointer hove:border   flex flex-col items-center py-3 ${userCourseInput?.category === item.name && "border-blue-700 border-2 bg-blue-100"}`}>
