...
const Finish = () => {
  ...
  return (
    ...
    <h1 className="font-semibold my-2.5 text-xl text-blue-600 tracking-wide ">
      ...
      <h1 className='text-xs mb-3 border max-w-max p-2 text-center text-gray-400 flex items-center gap-3 '>still-learning-sb4e.vercel./course/view/{course?.courseId}
